// Render each .slide in pr-41019-slides.html to a 16:9 PNG (2560x1440 @ 2x).
// Usage: node shot-slides.cjs   →   pr-41019-slides/slide-1.png ... slide-5.png
...
(async () => {
	const file = `file://${path.resolve(__dirname, 'pr-41019-slides.html')}`;
	const outdir = path.resolve(__dirname, 'pr-41019-slides');
