...
# TODO: install-i3 is apt-only and i3 is an X11 WM, so it is wrong on a Hyprland
# box. It is listed here because the pre-split Makefile ran it on every Linux
# and this commit is a pure move -- the omarchy-pkg rewrite drops it.
