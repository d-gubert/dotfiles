...
# Installs the host's user-level skills, agents and CLAUDE.md, staged and mounted
# read-only by initialize.sh. Here rather than on-create so editing any of them on
# the host takes effect on a restart.
